...
<body>
	...
	<div class="container">
		...
		<p>Sort by :
			...
			<a href="index.php?column=birthdate&order=desc">Age (ascending)</a> |
			<a href="index.php?column=birthdate&order=asc">Age (descending)</a>
		</p>
		<br>
					...
					<tbody>
						...
						foreach ($users as $user) : ?>
							<tr>
								...
								<td><?php echo DateTime::createFromFormat('Y-m-d', $user['birthdate'])->diff(new DateTime('now'))->y; ?> years</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
